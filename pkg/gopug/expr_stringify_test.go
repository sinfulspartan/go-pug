...
// accidental output change from the new scalar cases. The golden string
// reflects each shorthand class (`.name`, `.price`, `.footnote`) rendering as
// its own static literal even though the mixin's buffered variables share
// those same names — the correct, pug.js-matching behavior for a
// whole-quoted class value.
func TestRenderLargeTemplateByteIdenticalScalars(t *testing.T) {
	...
	const want = `<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><title>Benchmark Page</title></head><body><header><nav><a href="/">Home</a><a href="/about">About</a><a href="/contact">Contact</a></nav></header><main><h1>Welcome</h1><p>This is the intro paragraph.</p><ul class="items"><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li><li class="item"><span class="name">Product</span><span class="price">$9.99</span></li></ul><p class="footnote">Prices subject to change.</p></main><footer><p>&copy; 2025 Go-Pug</p></footer></body></html>`
